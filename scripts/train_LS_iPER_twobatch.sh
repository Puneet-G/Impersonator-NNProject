...
loss_path="trained_models/${name}/TwoBatch_loss_log2.txt"
...
graph_output="./plots_TwoBatchLoss/${name}"
...
zip -r plots_TwoBatchLoss.zip plots_TwoBatchLoss
sudo chmod -R 777 plots_TwoBatchLoss.zip
